...
//                      |=========|=========|=========|=========|=========|
  ...
  {'6'          ,0      ,'6'      ,'^'      ,WCH_NONE ,0x00bc   ,WCH_DEAD },
  ...
  {VK_OEM_7     ,0      ,'\''     ,'\"'     ,WCH_NONE ,WCH_DEAD ,WCH_DEAD },
  {0xff         ,0      ,WCH_NONE ,WCH_NONE ,WCH_NONE ,0x00b4   ,0x00a8   },
  {VK_OEM_3     ,0      ,'`'      ,'~'      ,WCH_NONE ,WCH_DEAD ,WCH_DEAD },
...
static ALLOC_SECTION_LDATA DEADKEY aDeadKey[] = {
    ...
    DEADTRANS( L'c'   , 0x00b4 , 0x00e7 , 0x0000),
    ...
    DEADTRANS( L'C'   , 0x00b4 , 0x00c7 , 0x0000),
